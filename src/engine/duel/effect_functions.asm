...
.search_table
	dw .SearchDeckForPokemon       ; SEARCHEFFECT_POKEMON
	dw .SearchDeckForNidoran       ; SEARCHEFFECT_NIDORAN
	dw .SearchDeckForBasicFighting ; SEARCHEFFECT_BASIC_FIGHTING
...
SpacingOut_HealEffect:
	...
	; checked in SpacingOut_CheckDamage
	ld e, PLAY_AREA_ARENA
	call GetCardDamageAndMaxHP
	or a
...
BigThunderEffect:
	...
	jp RandomlyDamagePlayAreaPokemon
...
MirrorMove_InitialEffect1:
	...
	inc hl
	ret nz ; return if has last turn damage or status
	ld a, [hli] ; DUELVARS_ARENA_CARD_LAST_TURN_SUBSTATUS2
	or a
	ret nz ; return if has last turn substatus
...
HyperBeam_AISelectEffect:
	call AIPickEnergyCardToDiscardFromDefendingPokemon
	ldh [hTemp_ffa0], a
	ret

HyperBeam_DiscardEffect:
	call HandleNoDamageOrEffect
	ret c ; is unaffected
	ldh a, [hTemp_ffa0]
	cp $ff
...
ClefableMetronome_UseAttackEffect:
	...
	jp HandlePlayerMetronomeEffect
...
ComputerSearch_PlayerDiscardHandSelection:
	jp HandlePlayerSelection2HandCardsToDiscard
