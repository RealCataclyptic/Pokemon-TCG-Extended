...
EnergySynchroEffectCommands: ; Do a bonus if energy attached to you and DFP is the same
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, SynchroCheckEffect
	dbw EFFECTCMDTYPE_AI, SynchoAIEffect
	db  $00		

EnergyCrushEffectCommands: ; adds 10dmg for each energy you have greater than the DFP's
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, EnergyCrushEffect
	dbw EFFECTCMDTYPE_AI, EnergyCrushAIEffect
	db  $00

Discard1RandomCardEffectCommands: ; discards a random card in opp's hand
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, Discard1RandomCardFromOpponentsHandEffect
	db  $00

OpponentMills1_EffectCommands: ; Opponent discards 1/X card from top of deck
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, OpponentMills1Effect
	db  $00

EveryoneMills10_EffectCommands: ;Everyone discards 10/X cards from top of deck
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, EveryoneMills10Effect
	db  $00

CantAttachEnergyNextTurnEffectCommands: ; DFP can't have an energy attached from hand during next turn (even if switched out)
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, CantAttachEnergyEffect
	db  $00

Damage10xYourHandCardsEffectCommands: ; Does 10x the number of cards in your hand. 
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, Do10XCardsInHandEffect
	dbw EFFECTCMDTYPE_AI, AI_Do10XCardsInHandEffect
	db  $00

Damage10xOppHandCardsEffectCommands: ; Does 10x the number of cards in opponent's hand. 
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, Do10XCardsInOppHandEffect
	dbw EFFECTCMDTYPE_AI, AI_Do10XCardsInOppHandEffect
	db  $00
...
Damage10xAllYourEnergyInPlay: ; Does 10 damage times all your energy (cards?) in play.
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, CalcAllEnergyInYourPlayAreaEffect
	dbw EFFECTCMDTYPE_AI, AI_CalcAllEnergyInYourPlayAreaEffect
	db  $00

Damage10xEveryonesEnergyInPlay: ; Does 10 damage times all energy cards in play.
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, CalcAllEnergyOnFieldEffect
	dbw EFFECTCMDTYPE_AI, AI_CalcAllEnergyOnFieldEffect
	db  $00

AttackEvolvePokemonEffectCommands: ; Attacks, then evolves the pokemon. 
	dbw EFFECTCMDTYPE_INITIAL_EFFECT_1, DeckCheck
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, ExplosiveEvolutionEffect
	db  $00

PlusDamageIfMorePrizesEffectCommands: ; does an effect if you have more prizes than opp
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, MorePrizesEffect
	dbw EFFECTCMDTYPE_AI, MorePrizesAIEffect
	db  $00

OnKOEffectCommands: ; Does an effect if you KO the opp.
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, OnKOEffect
	db  $00

AttachEnergyFromHandAttackEffectCommands: ; Attaches an energy from the hand as an attack.
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, AttachEnergyCardInHandEffect
	dbw EFFECTCMDTYPE_REQUIRE_SELECTION, AttachEnergyCardInHandSelectEffect
	; dbw EFFECTCMDTYPE_AI, AI_AttachEnergyCardInHandEffect ; DOESN'T WORK
	db  $00

CantUseUnlessDamagedEffectCommands: ; This attack can't be used unless you have damage counters. 
	dbw EFFECTCMDTYPE_INITIAL_EFFECT_1, CheckSelfDamage_Effect
	dbw EFFECTCMDTYPE_AI, CheckSelfDamage_AI_Effect
	db $00
