...
.ows_e3b6
	jump_if_card_owned ELECTABUZZ, .ows_e3be
	print_npc_text Text0613
	quit_script_fully

.ows_e3be
	jump_if_card_in_collection ELECTABUZZ, .ows_e3c6
...
.ows_e3c6
	...
	take_card ELECTABUZZ
	give_card ELECTABUZZ
	show_card_received_screen ELECTABUZZ
